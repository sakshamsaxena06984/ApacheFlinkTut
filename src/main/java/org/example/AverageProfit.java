...
public class AverageProfit {
    public static void main(String[] args) throws Exception {
        ...
        DataStream < String > data = env.readTextFile("/Users/sakshamsaxena/Desktop/flinkexample/avg.txt");
        ...
        profitPerMonth.writeAsText("/Users/sakshamsaxena/Desktop/flinkexample/profit_per_month1.txt");
