...
public class Aggregation {
    public static void main(String[] args) throws Exception {
        ...
        DataStream < String > data = env.readTextFile("/Users/sakshamsaxena/Desktop/flinkexample/avg1.txt");
        ...
        mapped.print();
        mapped.keyBy(t -> t.f0).sum(3).writeAsText("/Users/sakshamsaxena/Desktop/flinkexample/out1");

        mapped.keyBy(t -> t.f0).min(3).writeAsText("/Users/sakshamsaxena/Desktop/flinkexample/out2");

        mapped.keyBy(t -> t.f0).minBy(3).writeAsText("/Users/sakshamsaxena/Desktop/flinkexample/out3");

        mapped.keyBy(t -> t.f0).max(3).writeAsText("/Users/sakshamsaxena/Desktop/flinkexample/out4");

        mapped.keyBy(t -> t.f0).maxBy(3).writeAsText("/Users/sakshamsaxena/Desktop/flinkexample/out5");
        // execute program
